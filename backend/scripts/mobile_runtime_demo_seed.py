        ...
        "screens": [
            ...
            },
            {
                ...
                "payload": {
                    "type": "cheat_sheet",
                    "content": (
                        "<h3>Чек-лист проверки сообщения</h3>"
                        "<ul>"
                        "<li>Проверьте отправителя</li>"
                        "<li>Не открывайте вложения от неизвестных</li>"
                        "<li>Сверьте информацию в официальном канале школы</li>"
                        "</ul>"
                    ),
                },
            },
